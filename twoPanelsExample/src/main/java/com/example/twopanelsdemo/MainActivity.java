...
public class MainActivity extends TwoPanelsBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.right, mRightFragment).commit();
        getSupportFragmentManager().beginTransaction().add(R.id.left, mLeftFragment).commit();
    }
